...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Colegio ", "https://www.colegio.com",
			"admin@colegio.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Colegio WebFlux Api Documentation", "Colegio WebFlux Api Documentation", "1.0",
